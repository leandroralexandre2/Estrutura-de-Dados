...
// tipo para representar cada n贸 da 谩rvore
typedef struct _no {
    int chave;
    int h;
    struct _no *esq;
...
// busca um elemento a partir de um n贸
...
int no_insere(no_t *&raiz, int chave) {
    ...
    // a partir daqui, deve-se subir na 谩rvore e
